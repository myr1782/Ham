 ...
 * @version 1.0
 */
@Action(value = "project", results = { @Result(name = "success", location = "/page/sys/project.jsp"),
		@Result(name = "input", location = "/page/sys/project.jsp"),
		@Result(name = "edit", location = "/page/sys/projectEdit.jsp"),
		@Result(name = "init", type = "redirect", location = "project!doInit.action"), })
public class ProjectAction extends BaseAction implements ModelDriven<ProjectPage> {
	/** 序列化ID */
